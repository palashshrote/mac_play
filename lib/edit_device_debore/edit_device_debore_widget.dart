...
import 'edit_device_debore_model.dart';
export 'edit_device_debore_model.dart';

class EditDeviceDeboreWidget extends StatefulWidget {
  const EditDeviceDeboreWidget({super.key});

  @override
  State<EditDeviceDeboreWidget> createState() => _EditDeviceDeboreWidgetState();
}

class _EditDeviceDeboreWidgetState extends State<EditDeviceDeboreWidget>
    with TickerProviderStateMixin {
  late EditDeviceDeboreModel _model;
  ...
  void initState() {
    ...
    super.initState();
    _model = createModel(context, () => EditDeviceDeboreModel());
