...
class BorewellSummaryWidgetTwo extends StatefulWidget {
  const BorewellSummaryWidgetTwo({
    Key? key,
    this.bore,
  }) : super(key: key);
  ...
  @override
  _BorewellSummaryWidgetTwoState createState() => _BorewellSummaryWidgetTwoState();
}

class _BorewellSummaryWidgetTwoState extends State<BorewellSummaryWidgetTwo> {
